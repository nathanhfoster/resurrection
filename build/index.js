...
exports.useContext = exports.store = exports.useDispatch = exports.useSelector = exports.ContextConsumer = exports.ContextProvider = exports.connect = undefined;
...
var useContext = function useContext() {
  var context = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _provider.ContextConsumer;
  return (0, _react.useContext)(context);
};

// TODO dependencies
var useSelector = function useSelector(mapState, dependencies) {
  var _useContext = useContext(),
      state = _useContext.state;

  var returnedState = mapState(state);
...
exports.ContextProvider = _provider.ContextProvider;
exports.ContextConsumer = _provider.ContextConsumer;
exports.useSelector = useSelector;
exports.useDispatch = useDispatch;
exports.store = _provider.store;
...
exports.storeFactory = exports.store = exports.useDispatch = exports.useSelector = exports.ContextConsumer = exports.ContextProvider = exports.connect = undefined;
...
exports.connect = _provider.connect;
exports.ContextProvider = _provider.ContextProvider;
exports.ContextConsumer = _provider.ContextConsumer;
exports.useSelector = _provider.useSelector;
exports.useDispatch = _provider.useDispatch;
exports.store = _provider.store;
...
exports.store = exports.ContextConsumer = exports.ContextProvider = undefined;
...
var StateProvider = (0, _react.createContext)({});

var defaultInitializer = function defaultInitializer(state) {
  return state;
};

var store = (0, _.storeFactory)();

// This allows actions to dispatch other actions and pass (dispatch, getState)
var augmentDispatch = function augmentDispatch(dispatch, state) {
  return function (input) {
    // console.log(isAFunction(input), input)
    var getState = function getState() {
      return state;
    };
    return (0, _utils.isAFunction)(input) ? input(dispatch, getState) : dispatch(input);
  };
};
...
var ContextProvider = function ContextProvider(_ref) {
  ...
  var _useMemo = (0, _react.useMemo)(function () {
    return (0, _utils.combineReducers)(rootReducer, initialState);
  }, [rootReducer, initialState]),
      _useMemo2 = _slicedToArray(_useMemo, 2),
      mainState = _useMemo2[0],
      mainReducer = _useMemo2[1];

  // setup useReducer with the returned values of the combineReducers


  var _useReducer = (0, _react.useReducer)(mainReducer, mainState, initializer),
      _useReducer2 = _slicedToArray(_useReducer, 2),
      state = _useReducer2[0],
      dispatch = _useReducer2[1];

  var augmentedDispatch = augmentDispatch(dispatch, state);
  ...
  var contextValue = (0, _react.useMemo)(function () {
    return { state: state, dispatch: augmentedDispatch };
  }, [state, dispatch]);
...
ContextProvider.propTypes = {
  rootReducer: _propTypes2.default.oneOfType([_propTypes2.default.objectOf(_propTypes2.default.func.isRequired), _propTypes2.default.func]).isRequired,
  initialState: _propTypes2.default.object,
  initializer: _propTypes2.default.func,
  persistKey: _propTypes2.default.string,
...
exports.ContextConsumer = StateProvider;
exports.store = store;
...
exports.isQuotaExceeded = exports.isAFunction = exports.isPlainObject = exports.combineReducers = exports.actionTypes = undefined;
...
var isAFunction = function isAFunction(object) {
  return object instanceof Function || typeof object === "function";
};

var isQuotaExceeded = function isQuotaExceeded(e) {
...
exports.isAFunction = isAFunction;
...
var bindActionCreator = function bindActionCreator(actionCreator, dispatch, state) {
  var getState = function getState() {
    return state;
  };
  // Closure function
...
var bindActionCreators = function bindActionCreators(actionCreators, dispatch, state) {
  if (typeof actionCreators === "function") {
    return bindActionCreator(actionCreators, dispatch, state);
  }

  if ((typeof actionCreators === "undefined" ? "undefined" : _typeof(actionCreators)) !== "object" || actionCreators === null) {
    throw new Error("bindActionCreators expected an object or a function, instead received " + (actionCreators === null ? "null" : typeof actionCreators === "undefined" ? "undefined" : _typeof(actionCreators)) + ".");
  }
    ...
    function (Component) {
      return (
        ...
        function (ownProps) {
           ...
           */
          var _useContext = (0, _.useContext)(_provider.ContextConsumer),
              state = _useContext.state,
          ...
          var stateToProps = mapStateToProps ? React.useMemo(function () {
            return mapStateToProps(state, ownProps);
          }, [state, ownProps]) : null;

          // Memoize globalDispatch
          var dispatchToProps = React.useMemo(function () {
            return !mapDispatchToProps ? null : mapDispatchToProps instanceof Function || typeof mapDispatchToProps === "function" ? /**
          ...
          var combinedComponentProps = React.useMemo(function () {
            return _extends({}, ownProps, stateToProps, mapDispatchToProps && _extends({}, dispatchToProps));
          }, [ownProps, stateToProps, dispatchToProps]);

          // Pass all the key value combinedComponentProps to Component
          return React.createElement(Component, combinedComponentProps);
        }
      );
    }
  );
...
var combineReducers = function combineReducers(reducers, initialState) {
  // If a single reducer
  if ((0, _.isAFunction)(reducers)) {
    var _reducerFunction = function _reducerFunction(state, action) {
      var hasStateChanged = false;
      var updatedStateByReducers = {};

      var currentStateByKey = state;
      var currentReducer = reducers;

      var returnedStateByReducer = currentReducer(currentStateByKey, action);

      var areStateByKeyEqual = returnedStateByReducer !== currentStateByKey;
    ...
    return [initialState || {}, _reducerFunction];
  }
  ...
  var reducerFunction = function reducerFunction(state, action) {
    ...
    for (var reducer in reducers) {
      if (reducers.hasOwnProperty(reducer)) {
        var currentStateByKey = state[reducer];
  ...
  var combinedStateAndReducers = void 0;
